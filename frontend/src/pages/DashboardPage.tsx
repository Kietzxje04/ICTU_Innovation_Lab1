...
import type { FinalStatus, ProductType } from '../domain'
...
export function DashboardPage() {
  ...
  return <main className="page readiness-dashboard">
    ...
    <section className="readiness-metrics">
      ...
      <Metric label="Sẵn sàng HITL" value={String(ready)} note="Không phải quyết định tín dụng" icon={CheckCircle2} tone="green" />
