...
export function ReportPage() {
  ...
  return <main className="report-page">
    ...
    <article className="report-paper" id="company-supplement-report">
      ...
      <section className={`report-notice ${workflow.final_status === 'BLOCKED' ? 'blocked' : ''}`}><div><ShieldCheck size={19} /><span>Trạng thái sau kiểm chứng</span></div><strong>{FINAL_STATUS_LABELS[workflow.final_status]}</strong><p>Mandatory Critic: {workflow.critic_verdict} · {workflow.route.length} khâu đã được thực hiện.</p></section>
