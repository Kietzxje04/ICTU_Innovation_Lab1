...
export function ReportPage() {
  ...
  return <main className="report-page">
    ...
    <article className="report-paper" id="company-supplement-report">
      ...
      <section className="report-handler"><h2>Thông tin người xử lý báo cáo</h2><table><tbody><tr><th>Họ và tên</th><td>{user?.full_name ?? item.owner}</td><th>Chức vụ</th><td>{user?.role_name ?? user?.role_id ?? 'Chuyên viên'}</td></tr></tbody></table></section>
