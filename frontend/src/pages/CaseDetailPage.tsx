...
export function CaseDetailPage() {
  ...
  return <main className="case-workbench">
    ...
    <div className="workbench-grid"><div className="workbench-main">
      <WorkflowCanvas context={context} workflow={workflow} evidence={item.evidence} onRunComplete={() => { setWorkflowVerified(true); window.sessionStorage.setItem(`workflow-verified:${item.id}`, 'true') }} />
