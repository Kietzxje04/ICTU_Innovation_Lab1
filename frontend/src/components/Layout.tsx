...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? 'is-open' : ''}`}>
      ...
      <div className="agent-boundary"><Bot size={18} /><div><strong>Frontend sandbox</strong><span>Mock workflow · Không gọi LLM trực tiếp</span></div></div>
