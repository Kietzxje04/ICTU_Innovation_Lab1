...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? 'is-open' : ''}`}>
      ...
      <div className="agent-boundary"><Bot size={18} /><div><strong>Backend Agent runtime</strong><span>{dataMode === 'api' ? 'FastAPI workflow' : 'Fallback workflow'} · Browser không gọi LLM trực tiếp</span></div></div>
