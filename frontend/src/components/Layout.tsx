...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? 'is-open' : ''}`}>
      ...
      {user && <div className="sidebar-user"><strong>{user.full_name}</strong><span>{user.role_name ?? user.role_id}</span><button onClick={handleLogout}>Đăng xuất</button></div>}
